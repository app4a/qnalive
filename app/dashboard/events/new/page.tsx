      ...
      <main className="container mx-auto px-4 py-8 max-w-2xl">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Set up your interactive event and start engaging with your audience
            </CardDescription>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="space-y-2">
                ...
                <Input
                  id="title"
                  type="text"
                  placeholder="e.g., Q&A Session, Product Launch, Town Hall"
                  value={title}
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      Let participants submit questions without signing in
                    </p>
                  </div>
                </div>
